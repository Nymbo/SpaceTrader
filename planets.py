...
def createPlanetsWithDocks():
    ...
    dock.setCargoAmount(CARGO_1_NAME, 500)
    dock.addProducer(CargoProducer(CARGO_1_NAME, 7))
    ...
    dock.setCargoAmount(CARGO_2_NAME, 500)
    dock.addConsumer(CargoConsumer(CARGO_1_NAME, 1))
    dock.addProducer(CargoProducer(CARGO_2_NAME, 7))
    dock.addConsumer(CargoConsumer(CARGO_3_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_4_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_5_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_6_NAME, 1))
    ...
    dock.setCargoAmount(CARGO_3_NAME, 500)
    dock.addConsumer(CargoConsumer(CARGO_1_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_2_NAME, 1))
    dock.addProducer(CargoProducer(CARGO_3_NAME, 7))
    dock.addConsumer(CargoConsumer(CARGO_4_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_5_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_6_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_7_NAME, 1))
    ...
    dock.setCargoAmount(CARGO_4_NAME, 500)
    dock.addConsumer(CargoConsumer(CARGO_1_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_2_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_3_NAME, 1))
    dock.addProducer(CargoProducer(CARGO_4_NAME, 7))
    dock.addConsumer(CargoConsumer(CARGO_5_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_6_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_7_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_8_NAME, 1))
    ...
    dock.setCargoAmount(CARGO_5_NAME, 500)
    dock.addConsumer(CargoConsumer(CARGO_1_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_2_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_3_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_4_NAME, 1))
    dock.addProducer(CargoProducer(CARGO_5_NAME, 7))
    dock.addConsumer(CargoConsumer(CARGO_6_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_7_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_8_NAME, 1))
    scene.addSprite(dock)
    ...
    dock.setCargoAmount(CARGO_6_NAME, 500)
    dock.addConsumer(CargoConsumer(CARGO_1_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_2_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_3_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_4_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_5_NAME, 1))
    dock.addProducer(CargoProducer(CARGO_6_NAME, 7))
    dock.addConsumer(CargoConsumer(CARGO_7_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_8_NAME, 1))
    scene.addSprite(dock)
    docks.append(dock)
    ...
    dock.setCargoAmount(CARGO_7_NAME, 500)
    dock.addConsumer(CargoConsumer(CARGO_1_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_2_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_3_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_4_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_5_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_6_NAME, 1))
    dock.addProducer(CargoProducer(CARGO_7_NAME, 7))
    dock.addConsumer(CargoConsumer(CARGO_8_NAME, 1))
    scene.addSprite(planet)
    dock = Dock()
    dock.setName("Uranus")
    ...
    dock.setCargoAmount(CARGO_8_NAME, 500)
    dock.addConsumer(CargoConsumer(CARGO_1_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_2_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_3_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_4_NAME, 1))
    ...
    dock.addConsumer(CargoConsumer(CARGO_6_NAME, 1))
    dock.addConsumer(CargoConsumer(CARGO_7_NAME, 1))
    dock.addProducer(CargoProducer(CARGO_8_NAME, 7))
    scene.addSprite(dock)
    docks.append(dock)
